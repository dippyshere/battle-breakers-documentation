...
*https://wex-public-service-live-prod.ol.epicgames.com/wex/api/game/v2/profile/:accountId/SelectStartOptions?profileId=profile0&rvn=3*
...
```http
POST /wex/api/game/v2/profile/:accountId/SelectStartOptions?profileId=profile0&rvn=3 HTTP/1.1
```

...
*https://wex-public-service-live-prod.ol.epicgames.com/wex/api/game/v2/profile/:accountId/PromoteHero?profileId=profile0&rvn=40481*
...
```http
POST /wex/api/game/v2/profile/:accountId/PromoteHero?profileId=profile0&rvn=40481 HTTP/1.1
```
